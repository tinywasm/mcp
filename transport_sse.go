...
func WithSSEHeaderFunc(headerFunc HTTPHeaderFunc) SSEOption {
	return func(sc *SSE) {
...
func WithSSEOAuth(config OAuthConfig) SSEOption {
	return func(sc *SSE) {
...
func WithSSEHTTPHost(host string) SSEOption {
	return func(sc *SSE) {
		sc.host = host
	}
}
...
func NewSSE(baseURL string, options ...SSEOption) (*SSE, error) {
...
func NewSSEMCPClient(baseURL string, options ...SSEOption) (*Client, error) {
	sseTransport, err := NewSSE(baseURL, options...)
	if err != nil {
...
func (c *SSE) SetNotificationHandler(handler func(notification JSONRPCNotification)) {
	c.notifyMu.Lock()
...
func (c *SSE) SendNotification(ctx context.Context, notification JSONRPCNotification) error {
	if c.endpoint == nil {
