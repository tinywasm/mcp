...
type SessionWithElicitation interface {
	...
	RequestElicitation(ctx context.Context, request ElicitationRequest) (*ElicitationResult, error)
}
...
// SessionWithSampling is an extension of ClientSession that can send sampling requests
type SessionWithSampling interface {
	ClientSession
	// RequestSampling sends a create message request to the client and waits for response
	RequestSampling(ctx context.Context, request CreateMessageRequest) (*CreateMessageResult, error)
}
...
func (s *MCPServer) SendLogMessageToClient(ctx context.Context, notification LoggingMessageNotification) error {
...
func (s *MCPServer) SendLogMessageToSpecificClient(sessionID string, notification LoggingMessageNotification) error {
...
func (s *MCPServer) AddSessionResource(sessionID string, resource Resource, handler ResourceHandlerFunc) error {
...
func (s *MCPServer) AddSessionResourceTemplate(sessionID string, template ResourceTemplate, handler ResourceTemplateHandlerFunc) error {
